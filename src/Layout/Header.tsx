...
function useNavigation() {
	...
	return {
		...
		menuLinks: data.navigation.body.filter(l => l.type === "menu_link").map(ml => ml.primary) as MenuLink[],
		socials: data.navigation.body.filter(l => l.type === "social_media").map(ml => ml.primary) as Social[],
	};
}
